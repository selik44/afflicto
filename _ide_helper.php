 ...
 * Generated for Laravel 5.1.45 (LTS) on 2017-02-28.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Artisan {
        ...
        public static function handle($input, $output = null)
        {
            ...
            return \Friluft\Console\Kernel::handle($input, $output);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Friluft\Console\Kernel::terminate($input, $status);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Friluft\Console\Kernel::call($command, $parameters);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Friluft\Console\Kernel::queue($command, $parameters);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Friluft\Console\Kernel::all();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Friluft\Console\Kernel::output();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Friluft\Console\Kernel::bootstrap();
        }
...
namespace Friluft\Shopping\Facades {
    ...
    class Cart {
        ...
        {
            return \Friluft\Shopping\Cart\Cart::quantity();
        }
        ...
        {
            return \Friluft\Shopping\Cart\Cart::has($uid);
        }
         ...
         * @static 
         */
        public static function getSubTotalWithoutDiscounts($uid)
        {
            return \Friluft\Shopping\Cart\Cart::getSubTotalWithoutDiscounts($uid);
        }
         ...
         * @static 
         */
        public static function getTotalWithoutDiscounts()
        {
            return \Friluft\Shopping\Cart\Cart::getTotalWithoutDiscounts();
        }
        ...
        {
            return \Friluft\Shopping\Cart\Cart::getTotalTax();
        }
        ...
        {
            return \Friluft\Shopping\Cart\Cart::getRevenue();
        }
         ...
         * @static 
         */
        public static function getBestCumulativeCouponForProduct($product, $coupons)
        {
            return \Friluft\Shopping\Cart\Cart::getBestCumulativeCouponForProduct($product, $coupons);
        }
         ...
         * @static 
         */
        public static function canUseCoupon($code)
        {
            return \Friluft\Shopping\Cart\Cart::canUseCoupon($code);
        }
        ...
        {
            return \Friluft\Shopping\Cart\Cart::addCoupon($code);
        }
         ...
         * @static 
         */
        public static function numCoupons()
        {
            return \Friluft\Shopping\Cart\Cart::numCoupons();
        }
         ...
         * @static 
         */
        public static function hasCoupon($code)
        {
            return \Friluft\Shopping\Cart\Cart::hasCoupon($code);
        }
        ...
        {
            return \Friluft\Shopping\Cart\Cart::getCoupon($code);
        }
        ...
        {
            return \Friluft\Shopping\Cart\Cart::getCoupons();
        }
         ...
         * @static 
         */
        public static function getAmountSaved()
        {
            return \Friluft\Shopping\Cart\Cart::getAmountSaved();
        }
        
    }         
}
    
namespace Friluft\PDF\Facades {
    ...
    class Snappy {
        ...
        {
            return \Friluft\PDF\Snappy::make();
        }
         ...
         * @static 
         */
        public static function fromHTML($html, $fileName, $overWrite)
        {
            return \Friluft\PDF\Snappy::fromHTML($html, $fileName, $overWrite);
        }
...
namespace Friluft\Page {
    ...
    class Pages {
        ...
        {
            return \Friluft\Page\PageRenderer::trim($content);
        }
        
        /**
         * 
         *
         * @param \Friluft\Page\Page $page
         * @return string the compiled content
         * @static 
         */
        public static function compile($page)
        {
            return \Friluft\Page\PageRenderer::compile($page);
        }
        ...
        {
            return \Friluft\Page\PageRenderer::view($page);
        }
...
namespace Gentlefox\Laratables\Facades {
...
namespace {
    ...
    class Snappy extends \Friluft\PDF\Facades\Snappy {}
    
    class Pages extends \Friluft\Page\Pages {}
